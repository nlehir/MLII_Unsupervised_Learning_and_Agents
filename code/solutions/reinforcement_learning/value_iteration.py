...
def update_value_function(
    ...
    for i in range(1, world.shape[0] - 1):
        for j in range(1, world.shape[0] - 1):
            ...
            # max_next = np.max(next_values)
            if world[i, j]:
                # next_possible_values = [
                #     get_next_state_value(i-1, j-1, known_reward, value_function, GAMMA),
                #     get_next_state_value(i-1, j, known_reward, value_function, GAMMA),
                #     get_next_state_value(i-1, j+1, known_reward, value_function, GAMMA),
                #     get_next_state_value(i, j-1, known_reward, value_function, GAMMA),
                #     get_next_state_value(i, j, known_reward, value_function, GAMMA),
                #     get_next_state_value(i, j+1, known_reward, value_function, GAMMA),
                #     get_next_state_value(i+1, j-1, known_reward, value_function, GAMMA),
                #     get_next_state_value(i+1, j, known_reward, value_function, GAMMA),
                #     get_next_state_value(i+1, j+1, known_reward, value_function, GAMMA),
